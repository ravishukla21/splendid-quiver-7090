...
const Home = () => {
  ...
  useEffect(() => {
    setproduct456(
      document.querySelectorAll(`.${styles.todaydealsproductitem}`)
    );
  }, []);

  // console.log(product456, "setproduct4567979")
  let todaydealproductlist = document.querySelector(
    `.${styles.todaydealsproductlist}`
  );
  ...
  return (
    <div style={{ border: "0px solid red", marginBottom: "-300px" }}>
      ...
      <main
        style={{ border: "0px solid red", marginBottom: "-311px" }}
      ...
      >
        <div className={styles.cardproductcontainer}>
          ...
          <div className={styles.cardproduct}>
            ...
            <div className={styles.cardproductnestedcard}>
              <img src="https://images-eu.ssl-images-amazon.com/images/G/31/img19/Sports/GW_Desktop/1199101_379x304_Compressed._SY304_CB448278349_.jpg"></img>
            </div>
          </div>
        </div>
        ...
        <div className={styles.cardproductcontainer}>
          ...
          <div className={styles.cardproduct}>
            ...
            <button className={styles.cardproductbtn}>
              Explore more from local shops
            </button>
          </div>
          <div className={styles.cardproduct}>
            <h2>Up to 60% off | Styles for men</h2>
        ...
        <div className={styles.todaydealscontainer}>
          ...
          <div className={styles.todaydealsproductcontainer}>
            <div className={styles.todaydealsbtncontainer}>
              <button
                className={styles.todaydealsbtn}
                onClick={() => {
                  todaydealslideleft();
                }}
              >
            ...
            <div className={styles.todaydealsproductlist}>
              {todaydeals?.map((el, index) => {
                return (
                  <div className={styles.todaydealsproductitem} key={index}>
